...
class VideoPlayerPluginHls extends VideoPlayerPlatform {
  ...
  Future<int> create(DataSource dataSource) async {
    ...
    ui_web.platformViewRegistry.registerViewFactory('videoPlayer-$textureId', (int viewId) => videoElement);

    final VideoPlayer player =
        VideoPlayer(videoElement: videoElement, uri: uri, headers: headers ?? Map<String, String>());
